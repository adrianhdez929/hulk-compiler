 ...
 */
class LALR1ParsingError : public std::runtime_error {
public:
    /**
     ...
     */
    LALR1ParsingError(const std::string& message, int state, const std::string& token, 
...
public:
     ...
     */
    static LALR1Parser* deserialize_parser(const std::string& filename, Grammar& grammar);
     ...
     * @return Puntero a un nuevo Parser deserializado, o nullptr si hay error
     */
    static LALR1Parser* deserialize_parser(const std::string& filename, const std::string& directory, Grammar& grammar);
